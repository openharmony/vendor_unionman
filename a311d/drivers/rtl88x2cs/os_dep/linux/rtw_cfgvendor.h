...
typedef enum {
    RTW_WIFI_CHAN_WIDTH_20    = 0,
    RTW_WIFI_CHAN_WIDTH_40    = 1,
    RTW_WIFI_CHAN_WIDTH_80    = 2,
    RTW_WIFI_CHAN_WIDTH_160   = 3,
    RTW_WIFI_CHAN_WIDTH_80P80 = 4,
    RTW_WIFI_CHAN_WIDTH_5     = 5,
    RTW_WIFI_CHAN_WIDTH_10    = 6,
    RTW_WIFI_CHAN_WIDTH_INVALID = -1
} wifi_channel_width;
