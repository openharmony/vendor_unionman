...
#else
	ktime_get_real_ts64(&p_ctx->t_frm);
	p_ctx->autocap_frame[type].endtime = (p_ctx->t_frm.tv_sec*1000000 + p_ctx->t_frm.tv_nsec / 1000)/1000;
#endif
