...
static inline bool tee_enabled(void)
{
	return false;
}

static inline uint32_t tee_protect_tvp_mem(uint32_t start, uint32_t size,
			uint32_t *handle)
{
	return 0xFFFFFFFF;
}

static inline int is_secload_get(void)
{
	return 0;
}

static inline void tee_unprotect_tvp_mem(uint32_t handle)
{
}

static inline int tee_load_video_fw_swap(uint32_t index, uint32_t vdec, bool is_swap)
{
	return -1;
}

static inline int tee_load_video_fw(uint32_t index, uint32_t vdec)
{
	return -1;
}
#else
