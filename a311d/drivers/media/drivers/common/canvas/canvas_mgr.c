...
static struct attribute *canvas_class_attrs[] = {
...
ATTRIBUTE_GROUPS(canvas_class);

static struct class canvas_class = {
	.name = "amcanvas",
	.class_groups = canvas_class_groups,
};

// NOTE: FIXME, reserve low range for New CANVAS in linux5.10
static void canvas_pool_config(void)
{
	canvas_pool_init();

	//canvas_pool_register_const_canvas(0, 0x25, "amvdec"); // FIXME
	//canvas_pool_register_const_canvas(0x26, 0x39, "vdin");
	//canvas_pool_register_const_canvas(0x78, 0xbf, "amvdec"); // FIXME
