 ...
 * @tc.desc      : Verify iswspace_l process success. when using the en_US.UTF-8 character set.
 ...
 * @tc.desc      : Verify iswspace_l process fail when using the en_US.UTF-8 character set.
 ...
 * @tc.desc      : Verify iswspace_l process when using the en_US.UTF-8 character set
...
void iswspace_l_0600(void)
{
    ...
    for (int i = 0; i < SIZE; i++) {
        ret = iswspace_l((char)i, m_locale);
        if (ret) {
            total++;
        }
    }
...
/**
 * @tc.name      : iswspace_l_0800
 * @tc.desc      : Verify iswspace_l process fail when using the en_US.UTF-8 character set.
 *                 the parameter c is control character beside space charater,
 *                  which determines that the input character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_0800(void)
{
    int ret = RET_FALSE;
...
/**
 * @tc.name      : iswspace_l_1100
 * @tc.desc      : Verify iswspace_l process fail when using the en_US.UTF-8 character set
 *                 When the parameter c is a special character,
 *           and it is judged that the input wide character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_1100(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"!@#$%^()+{}[]";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswspace_l_1200
 * @tc.desc      : Verify iswspace_l process success. when using the zh_CN character set.
 *                 the parameter c is one of a space in {'\t', '\n', '\v', '\f', '\r', ' '},
 *                 and the input character is judged to be a space character.
 * @tc.level     : Level 0
 */
void iswspace_l_1200(void)
{
    int ret = RET_FALSE;
    const int arr[] = {'\t', '\n', '\v', '\f', '\r', ' '};
...
/**
 * @tc.name      : iswspace_l_1300
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN character set.
 *                 the parameter c is a control character beside space charater,
 *                  which determines that the input character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_1300(void)
{
    int ret = RET_FALSE;
...
/**
 * @tc.name      : iswspace_l_1500
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN character set
 *                 When the parameter c a is numeric,
 *                 and it is judged that the input character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_1500(void)
{
    int ret = RET_FALSE;
    const char *str = "1234567890";
    const char *p = str;
...
/**
 * @tc.name      : iswspace_l_1600
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN character set
 *                 When the parameter c is a special character,
 *           and it is judged that the input character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_1600(void)
{
    int ret = RET_FALSE;
    const char *str = "!@#$%^()+{}[]";
    const char *p = str;
...
/**
 * @tc.name      : iswspace_l_1700
 * @tc.desc      : Verify iswspace_l process when using the zh_CN character set
 *                 Determine the number of space characters in the ascii code table.
 * @tc.level     : Level 1
 */
void iswspace_l_1700(void)
{
    int ret = RET_FALSE;
    int total = 0;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
...
/**
 * @tc.name      : iswspace_l_1800
 * @tc.desc      : Verify iswspace_l process success. when using the zh_CN character set.
 *                 the parameter c is one of a space {L'\t', L'\n', L'\v', L'\f', L'\r', L' '},
 *                 and the input wide character is judged to be a space character.
 * @tc.level     : Level 0
 */
void iswspace_l_1800(void)
{
    int ret = RET_FALSE;
    const wchar_t arr[] = {L'\t', L'\n', L'\v', L'\f', L'\r', L' '};
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
...
/**
 * @tc.name      : iswspace_l_2000
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN character set 
 *                 When the parameter c is an English letter,
 *                 and it is judged that the input wide character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_2000(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswspace_l_2100
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN character set
 *                 When the parameter c is numeric,
 *                 and it is judged that the input wide character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_2100(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"1234567890";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswspace_l_2200
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN character set
 *                 When the parameter c is a special character,
 *           and it is judged that the input wide character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_2200(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"!@#$%^()+{}[]";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswspace_l_2300
 * @tc.desc      : Verify iswspace_l process success when using the zh_CN character set
 *                 When the parameter c is a SPACE-like character,
 * @tc.level     : Level 0
 */
void iswspace_l_2300(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
    int total = 0;
...
/**
 * @tc.name      : iswspace_l_2500
 * @tc.desc      : Verify iswspace_l process success. when using the zh_CN.UTF-8 character set.
 *                 the parameter c is one of a space in {'\t', '\n', '\v', '\f', '\r', ' '},
 *                 and the input character is judged to be a space character.
 * @tc.level     : Level 0
 */
void iswspace_l_2500(void)
{
    int ret = RET_FALSE;
    const int arr[] = {'\t', '\n', '\v', '\f', '\r', ' '};
...
/**
 * @tc.name      : iswspace_l_2600
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a control character beside space charater,
 *                  which determines that the input character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_2600(void)
{
    int ret = RET_FALSE;
    const int arr[] = {0x0, 0x1, 0x2, 0x3, 0x11, 0x12, 0x13,0x14, 0x19, 0x21};
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
...
/**
 * @tc.name      : iswspace_l_2700
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN.UTF-8 character set 
 *                 When the parameter c is an English letter,
 *                 and it is judged that the input character is not a space.
 * @tc.level     : Level 2
 */
void iswspace_l_2700(void)
{
    int ret = RET_FALSE;
    const char *str = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    const char *p = str;
...
/**
 * @tc.name      : iswspace_l_2800
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN.UTF-8 character set
 *                 When the parameter c a is numeric,
 *                 and it is judged that the input character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_2800(void)
{
    int ret = RET_FALSE;
    const char *str = "1234567890";
    const char *p = str;
...
/**
 * @tc.name      : iswspace_l_2900
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN.UTF-8 character set
 *                 When the parameter c is a special character,
 *           and it is judged that the input character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_2900(void)
{
    int ret = RET_FALSE;
    const char *str = "!@#$%^()+{}[]";
    const char *p = str;
...
/**
 * @tc.name      : iswspace_l_3000
 * @tc.desc      : Verify iswspace_l process when using the zh_CN.UTF-8 character set
 *                 Determine the number of space characters in the ascii code table.
 * @tc.level     : Level 1
 */
void iswspace_l_3000(void)
{
    int ret = RET_FALSE;
    int total = 0;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
...
/**
 * @tc.name      : iswspace_l_3100
 * @tc.desc      : Verify iswspace_l process success. when using the zh_CN.UTF-8 character set.
 *                 the parameter c is one of a space {L'\t', L'\n', L'\v', L'\f', L'\r', L' '},
 *                 and the input wide character is judged to be a space character.
 * @tc.level     : Level 0
 */
void iswspace_l_3100(void)
{
    int ret = RET_FALSE;
    const wchar_t arr[] = {L'\t', L'\n', L'\v', L'\f', L'\r', L' '};
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
...
/**
 * @tc.name      : iswspace_l_3200
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is control character beside space charater,
 *                  which determines that the input wide character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_3200(void)
{
    int ret = RET_FALSE;
    const wchar_t arr[] = {0x0, 0x1, 0x2, 0x3, 0x11, 0x12, 0x13,0x14, 0x19, 0x21};
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
...
/**
 * @tc.name      : iswspace_l_3300
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN.UTF-8 character set 
 *                 When the parameter c is an English letter,
 *                 and it is judged that the input wide character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_3300(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswspace_l_3400
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN.UTF-8 character set
 *                 When the parameter c is numeric,
 *                 and it is judged that the input wide character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_3400(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"1234567890";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswspace_l_3500
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN.UTF-8 character set
 *                 When the parameter c is a special character,
 *           and it is judged that the input wide character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_3500(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"!@#$%^()+{}[]";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswspace_l_3600
 * @tc.desc      : Verify iswspace_l process success when using the zh_CN.UTF-8 character set
 *                 When the parameter c is a SPACE-like character,
 * @tc.level     : Level 0
 */
void iswspace_l_3600(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
    int total = 0;
...
/**
 * @tc.name      : iswspace_l_3700
 * @tc.desc      : Verify iswspace_l process fail when using the zh_CN.UTF-8 character set
 *                 When the parameter c is a CJK RADICAL or Arabic character,
 *           and it is judged that the input wide character is not a space character.
 * @tc.level     : Level 2
 */
void iswspace_l_3700(void)
{
    int ret = RET_FALSE;
    int i = 0;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
