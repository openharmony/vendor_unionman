 ...
 * @tc.desc      : Verify iswcntrl_l process success. when using the en_US.UTF-8 character set.
 ...
 * @tc.desc      : Verify iswcntrl_l process fail when using the en_US.UTF-8 character set.
...
/**
 * @tc.name      : iswcntrl_l_0700
 * @tc.desc      : Verify iswcntrl_l process fail when using the en_US.UTF-8 character set.
 *                 the parameter c is a wide char special character,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_0700(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"!@#$%^(){}[]";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswcntrl_l_0800
 * @tc.desc      : Verify iswcntrl_l process fail when using the en_US.UTF-8 character set.
 *                 the parameter c is a wide char number character,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_0800(void)
{
    int ret = RET_FALSE;
...
/**
 * @tc.name      : iswcntrl_l_0900
 * @tc.desc      : Verify iswcntrl_l process fail when using the en_US.UTF-8 character set.
 *                 the parameter c is a wide char English letter,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_0900(void)
{
    int ret = RET_FALSE;
...
/**
 * @tc.name      : iswcntrl_l_1000
 * @tc.desc      : Verify iswcntrl_l process success. when using the zh_CN character set.
 *                 the parameter c is a control character,
 *                 and the input character is judged to be a control character.
 * @tc.level     : Level 0
 */
void iswcntrl_l_1000(void)
{
    int ret = RET_FALSE;
    // arr : control character array
    const char arr[] = {0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc, 0xd, 0xe, 0xf, 0x10,
...
/**
 * @tc.name      : iswcntrl_l_1100
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN character set.
 *                 the parameter c is a special character,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_1100(void)
{
    int ret = RET_FALSE;
    const char *str = "!@#$%^(){}[]";
    const char *p = str;
...
/**
 * @tc.name      : iswcntrl_l_1200
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN character set.
 *                 the parameter c is a number character,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_1200(void)
{
    int ret = RET_FALSE;
    const char *str = "1234567890";
    const char *p = str;
...
/**
 * @tc.name      : iswcntrl_l_1300
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN character set.
 *                 the parameter c is a English letter,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_1300(void)
{
    int ret = RET_FALSE;
    const char *str = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    const char *p = str;
...
/**
 * @tc.name      : iswcntrl_l_1400
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN character set.
 *                 Determine the number in unicode table 0 ~ 256.
 * @tc.level     : Level 1
 */
void iswcntrl_l_1400(void)
{
    int ret = RET_FALSE;
    int total = 0;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
...
/**
 * @tc.name      : iswcntrl_l_1500
 * @tc.desc      : Verify iswcntrl_l process success. when using the zh_CN character set.
 *                 the parameter c is a wide char control character,
 *                 and the input character is judged to be a control character.
 * @tc.level     : Level 0
 */
void iswcntrl_l_1500(void)
{
    int ret = RET_FALSE;
    const wchar_t arr[] = {0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc, 0xd, 0xe, 0xf, 0x10,
                0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x7f};
...
/**
 * @tc.name      : iswcntrl_l_1600
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN character set.
 *                 the parameter c is a wide char special character,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_1600(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"!@#$%^(){}[]";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswcntrl_l_1700
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN character set.
 *                 the parameter c is a wide char number character,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_1700(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"1234567890";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswcntrl_l_1800
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN character set.
 *                 the parameter c is a wide char English letter,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_1800(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswcntrl_l_2100
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN character set.
 *                 the parameter c is a CJK Ideograph character,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_2100(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
...
/**
 * @tc.name      : iswcntrl_l_2200
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN character set.
 *                 the parameter c is a LATIN SMALL LETTER,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_2200(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
...
/**
 * @tc.name      : iswcntrl_l_2300
 * @tc.desc      : Verify iswcntrl_l process success. when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a control character,
 *                 and the input character is judged to be a control character.
 * @tc.level     : Level 0
 */
void iswcntrl_l_2300(void)
{
    int ret = RET_FALSE;
    // arr : control character array
    const char arr[] = {0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc, 0xd, 0xe, 0xf, 0x10,
...
/**
 * @tc.name      : iswcntrl_l_2400
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a special character,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_2400(void)
{
    int ret = RET_FALSE;
    const char *str = "!@#$%^(){}[]";
    const char *p = str;
...
/**
 * @tc.name      : iswcntrl_l_2500
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a number character,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_2500(void)
{
    int ret = RET_FALSE;
    const char *str = "1234567890";
    const char *p = str;
...
/**
 * @tc.name      : iswcntrl_l_2600
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a English letter,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_2600(void)
{
    int ret = RET_FALSE;
    const char *str = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    const char *p = str;
...
/**
 * @tc.name      : iswcntrl_l_2700
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN.UTF-8 character set.
 *                 Determine the number in unicode table 0 ~ 256.
 * @tc.level     : Level 1
 */
void iswcntrl_l_2700(void)
{
    int ret = RET_FALSE;
    int total = 0;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
...
/**
 * @tc.name      : iswcntrl_l_2800
 * @tc.desc      : Verify iswcntrl_l process success. when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a wide char control character,
 *                 and the input character is judged to be a control character.
 * @tc.level     : Level 0
 */
void iswcntrl_l_2800(void)
{
    int ret = RET_FALSE;
    const wchar_t arr[] = {0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb, 0xc, 0xd, 0xe, 0xf, 0x10,
                0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x7f};
...
/**
 * @tc.name      : iswcntrl_l_2900
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a wide char special character,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_2900(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"!@#$%^(){}[]";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswcntrl_l_3000
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a wide char number character,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_3000(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"1234567890";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswcntrl_l_3100
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a wide char English letter,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_3100(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    const wchar_t *p = str;
...
/**
 * @tc.name      : iswcntrl_l_3200
 * @tc.desc      : Verify iswcntrl_l process success when using the zh_CN.UTF-8 character set
 *                 When the parameter c is a Arabic character or some cntrl characters,
 *              and the input character is judged to be a control character.
 * @tc.level     : Level 0
 */
void iswcntrl_l_3200(void)
{
    int ret = RET_FALSE;
    int i = 0;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
...
/**
 * @tc.name      : iswcntrl_l_3300
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN.UTF-8 character set
 *                 When the parameter c is a CJK RADICAL or Arabic character,
 *              and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_3300(void)
{
    int ret = RET_FALSE;
    int i = 0;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
...
/**
 * @tc.name      : iswcntrl_l_3400
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a CJK Ideograph character,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_3400(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
    const wchar_t *arr = L"零一二三四五六七八九十";
...
/**
 * @tc.name      : iswcntrl_l_3500
 * @tc.desc      : Verify iswcntrl_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a LATIN SMALL LETTER,
 *                 and the input character is judged to be not a control character.
 * @tc.level     : Level 2
 */
void iswcntrl_l_3500(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
    const wchar_t *arr = L"āōēīūǖ";
