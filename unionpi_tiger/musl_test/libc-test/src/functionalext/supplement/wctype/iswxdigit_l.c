 ...
 * @tc.desc      : Verify iswxdigit_l process success. when using the en_US.UTF-8 character set.
 ...
 * @tc.desc      : Verify iswxdigit_l process fail when using the en_US.UTF-8 character set.
...
void iswxdigit_l_0400(void)
{
    ...
    for(int i = 0; i < sizeof(arr)/sizeof(int); i++) {
        ret = iswxdigit_l(arr[i], m_locale);
        if(ret) {
...
/**
 * @tc.name      : iswxdigit_l_0700
 * @tc.desc      : Verify iswxdigit_l process fail when using the en_US.UTF-8 character set.
 *                 the parameter c is a wide char special character,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_0700(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "en_US.UTF-8", NULL);
    const wchar_t *str = L"~!@#$%^&*(){}[]<>,.|";
...
/**
 * @tc.name      : iswxdigit_l_0800
 * @tc.desc      : Verify iswxdigit_l process fail when using the en_US.UTF-8 character set.
 *                 the parameter c is a wide char control character,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_0800(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "en_US.UTF-8", NULL);
...
/**
 * @tc.name      : iswxdigit_l_0900
 * @tc.desc      : Verify iswxdigit_l using the en_US.UTF-8 character set.
 *                  Determine the number of hexadecimal digit characters in the ascii code table
 * @tc.level     : Level 1
 */
void iswxdigit_l_0900(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "en_US.UTF-8", NULL);
    int total = 0;
...
/**
 * @tc.name      : iswxdigit_l_1000
 * @tc.desc      : Verify iswxdigit_l process success. when using the zh_CN character set.
 *                 the parameter c is hexadecimal digit character,
 *                 and the input character is judged to be a hexadecimal digit character.
 * @tc.level     : Level 0
 */
void iswxdigit_l_1000(void)
{
    int ret = RET_FALSE;
...
/**
 * @tc.name      : iswxdigit_l_1100
 * @tc.desc      : Verify iswxdigit_l process fail when using the zh_CN character set.
 *                 the parameter c is no-hexadecimal digit letter,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_1100(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
    const char *str = "gGhHiIjJkKlLmMnNoOpPqQrRsStTuUvVwWxXyYzZ";
...
/**
 * @tc.name      : iswxdigit_l_1200
 * @tc.desc      : Verify iswxdigit_l process fail when using the zh_CN character set.
 *                 the parameter c is a special character,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_1200(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
    const char *str = "~!@#$%^&*(){}[]<>,.|";
...
/**
 * @tc.name      : iswxdigit_l_1300
 * @tc.desc      : Verify iswxdigit_l process fail when using the zh_CN character set.
 *                 the parameter c is a control character,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_1300(void)
{
    int ret = 0;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
    const int arr[] = {0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xA, 0xB, 0xC, 0xD, 0xE, 0xF, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16};
...
/**
 * @tc.name      : iswxdigit_l_1400
 * @tc.desc      : Verify iswxdigit_l process success. when using the zh_CN character set.
 *                 the parameter c is wide char hexadecimal digit character,
 *                 and the input character is judged to be a hexadecimal digit character.
 * @tc.level     : Level 0
 */
void iswxdigit_l_1400(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
    const wchar_t *str = L"0123456789AaBbCcDdEeFf";
...
/**
 * @tc.name      : iswxdigit_l_1600
 * @tc.desc      : Verify iswxdigit_l process fail when using the zh_CN character set.
 *                 the parameter c is wide char special character,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_1600(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
    const wchar_t *str = L"~!@#$%^&*(){}[]<>,.|";
...
/**
 * @tc.name      : iswxdigit_l_1700
 * @tc.desc      : Verify iswxdigit_l process fail when using the zh_CN character set.
 *                 the parameter c is wide char control character,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_1700(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
    const wchar_t arr[] = {0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xA, 0xB, 0xC, 0xD, 0xE, 0xF, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16};
...
/**
 * @tc.name      : iswxdigit_l_1800
 * @tc.desc      : Verify iswxdigit_l using the zh_CN character set.
 *                  Determine the number of hexadecimal digit characters in the ascii code table
 * @tc.level     : Level 1
 */
void iswxdigit_l_1800(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
    int total = 0;
...
/**
 * @tc.name      : iswxdigit_l_1900
 * @tc.desc      : Verify iswxdigit_l process success when using the zh_CN character set.
 *                 the parameter c is TIBETAN DIGIT characters,
 *                 and the input character is judged to be a hexadecimal digit character.
 * @tc.level     : Level 0
 */
void iswxdigit_l_1900(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
    int total = 0;
...
/**
 * @tc.name      : iswxdigit_l_2100
 * @tc.desc      : Verify iswxdigit_l process success. when using the zh_CN.UTF-8 character set.
 *                 the parameter c is hexadecimal digit character,
 *                 and the input character is judged to be a hexadecimal digit character.
 * @tc.level     : Level 0
 */
void iswxdigit_l_2100(void)
{
    int ret = RET_FALSE;
...
/**
 * @tc.name      : iswxdigit_l_2200
 * @tc.desc      : Verify iswxdigit_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is no-hexadecimal digit letter,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_2200(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
    const char *str = "gGhHiIjJkKlLmMnNoOpPqQrRsStTuUvVwWxXyYzZ";
...
/**
 * @tc.name      : iswxdigit_l_2300
 * @tc.desc      : Verify iswxdigit_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a special character,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_2300(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
    const char *str = "~!@#$%^&*(){}[]<>,.|";
...
/**
 * @tc.name      : iswxdigit_l_2400
 * @tc.desc      : Verify iswxdigit_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a control character,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_2400(void)
{
    int ret = 0;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
    const int arr[] = {0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xA, 0xB, 0xC, 0xD, 0xE, 0xF, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16};
...
/**
 * @tc.name      : iswxdigit_l_2500
 * @tc.desc      : Verify iswxdigit_l process success. when using the zh_CN.UTF-8 character set.
 *                 the parameter c is wide char hexadecimal digit character,
 *                 and the input character is judged to be a hexadecimal digit character.
 * @tc.level     : Level 0
 */
void iswxdigit_l_2500(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
    const wchar_t *str = L"0123456789AaBbCcDdEeFf";
...
/**
 * @tc.name      : iswxdigit_l_2600
 * @tc.desc      : Verify iswxdigit_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is wide char no-hexadecimal digit letter character,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_2600(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
    const wchar_t *str = L"gGhHiIjJkKlLmMnNoOpPqQrRsStTuUvVwWxXyYzZ";
...
/**
 * @tc.name      : iswxdigit_l_2700
 * @tc.desc      : Verify iswxdigit_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is wide char special character,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_2700(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
    const wchar_t *str = L"~!@#$%^&*(){}[]<>,.|";
...
/**
 * @tc.name      : iswxdigit_l_2800
 * @tc.desc      : Verify iswxdigit_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is wide char control character,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_2800(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
    const wchar_t arr[] = {0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xA, 0xB, 0xC, 0xD, 0xE, 0xF, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16};
...
/**
 * @tc.name      : iswxdigit_l_2900
 * @tc.desc      : Verify iswxdigit_l using the zh_CN.UTF-8 character set.
 *                  Determine the number of hexadecimal digit characters in the ascii code table
 * @tc.level     : Level 1
 */
void iswxdigit_l_2900(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
    int total = 0;
...
/**
 * @tc.name      : iswxdigit_l_3000
 * @tc.desc      : Verify iswxdigit_l process success when using the zh_CN.UTF-8 character set.
 *                 the parameter c is TIBETAN DIGIT characters,
 *                 and the input character is judged to be a hexadecimal digit character.
 * @tc.level     : Level 0
 */
void iswxdigit_l_3000(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
    int total = 0;
...
/**
 * @tc.name      : iswxdigit_l_3100
 * @tc.desc      : Verify iswxdigit_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is CJK Ideograph or TIBETAN DIGIT HALF characters,
 *                 and the input character is judged to be a no-hexadecimal digit character.
 * @tc.level     : Level 2
 */
void iswxdigit_l_3100(void)
{
    int ret = RET_FALSE;
    int i = 0;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
