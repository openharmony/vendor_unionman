...
/**
 * @tc.name      : isblank_l_1800
 * @tc.desc      : Verify isblank_l process success. when using the zh_CN character set.
 *                 the parameter c is one of a space in {L'\t', L' '},
 *                 and the input wide character is judged to be a space.
 * @tc.level     : Level 0
 */
void isblank_l_1800(void)
{
    int ret = RET_FALSE;
    const wchar_t arr[] = {L'\t', L' '};
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
...
/**
 * @tc.name      : isblank_l_1900
 * @tc.desc      : Verify isblank_l process fail when using the zh_CN character set.
 *                 the parameter c is a wide char control character,
 *                  which determines that the input wide character is not a space.
 * @tc.level     : Level 2
 */
void isblank_l_1900(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"\r\n\b\0\f";
    const wchar_t *p = str;
...
/**
 * @tc.name      : isblank_l_2000
 * @tc.desc      : Verify isblank_l process fail when using the zh_CN character set 
 *                 When the parameter c is a wide char English letter,
 *                 and it is judged that the input wide character is not a space.
 * @tc.level     : Level 2
 */
void isblank_l_2000(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    const wchar_t *p = str;
...
/**
 * @tc.name      : isblank_l_2100
 * @tc.desc      : Verify isblank_l process fail when using the zh_CN character set
 *                 When the parameter c is a wide char alphanumeric,
 *                 and it is judged that the input wide character is not a space.
 * @tc.level     : Level 2
 */
void isblank_l_2100(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"1234567890";
    const wchar_t *p = str;
...
/**
 * @tc.name      : isblank_l_2200
 * @tc.desc      : Verify isblank_l process fail when using the zh_CN character set
 *                 When the parameter c is a wide char special character,
 *           and it is judged that the input wide character is not a space.
 * @tc.level     : Level 2
 */
void isblank_l_2200(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"!@#$%^()+{}[]";
    const wchar_t *p = str;
...
/**
 * @tc.name      : isblank_l_2300
 * @tc.desc      : Verify isblank_l process success when using the zh_CN character set
 *                 When the parameter c is a SPACE-like character,
 * @tc.level     : Level 0
 */
void isblank_l_2300(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN", NULL);
    int total = 0;
...
/**
 * @tc.name      : isblank_l_2500
 * @tc.desc      : Verify isblank_l process success. when using the zh_CN.UTF-8 character set.
 *                 the parameter c is one of a space in {'\t', ' '}),
 *                 and the input character is judged to be a space.
 * @tc.level     : Level 0
 */
void isblank_l_2500(void)
{
    int ret = RET_FALSE;
    const int arr[] = {'\t', ' '};
...
/**
 * @tc.name      : isblank_l_2600
 * @tc.desc      : Verify isblank_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is control character,
 *                  which determines that the input character is not a space.
 * @tc.level     : Level 2
 */
void isblank_l_2600(void)
{
    int ret = RET_FALSE;
    const char *str = "\r\n\b\0\f";
    const char *p = str;
...
/**
 * @tc.name      : isblank_l_2700
 * @tc.desc      : Verify isblank_l process fail when using the zh_CN.UTF-8 character set 
 *                 When the parameter c is an English letter,
 *                 and it is judged that the input character is not a space.
 * @tc.level     : Level 2
 */
void isblank_l_2700(void)
{
    int ret = RET_FALSE;
    const char *str = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    const char *p = str;
...
/**
 * @tc.name      : isblank_l_2800
 * @tc.desc      : Verify isblank_l process fail when using the zh_CN.UTF-8 character set
 *                 When the parameter c is alphanumeric,
 *                 and it is judged that the input character is not a space.
 * @tc.level     : Level 2
 */
void isblank_l_2800(void)
{
    int ret = RET_FALSE;
    const char *str = "1234567890";
    const char *p = str;
...
/**
 * @tc.name      : isblank_l_2900
 * @tc.desc      : Verify isblank_l process fail when using the zh_CN.UTF-8 character set
 *                 When the parameter c is a special character,
 *           and it is judged that the input character is not a space.
 * @tc.level     : Level 2
 */
void isblank_l_2900(void)
{
    int ret = RET_FALSE;
    const char *str = "!@#$%^()+{}[]";
    const char *p = str;
...
/**
 * @tc.name      : isblank_l_3000
 * @tc.desc      : Verify isblank_l process when using the zh_CN.UTF-8 character set
 *                 Determine the number of space characters in the ascii code table.
 * @tc.level     : Level 1
 */
void isblank_l_3000(void)
{
    int ret = RET_FALSE;
    int total = 0;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
...
/**
 * @tc.name      : isblank_l_3100
 * @tc.desc      : Verify isblank_l process success. when using the zh_CN.UTF-8 character set.
 *                 the parameter c is one of a space in {L'\t', L' '},
 *                 and the input wide character is judged to be a space.
 * @tc.level     : Level 0
 */
void isblank_l_3100(void)
{
    int ret = RET_FALSE;
    const wchar_t arr[] = {L'\t', L' '};
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
...
/**
 * @tc.name      : isblank_l_3200
 * @tc.desc      : Verify isblank_l process fail when using the zh_CN.UTF-8 character set.
 *                 the parameter c is a wide char control character,
 *                  which determines that the input wide character is not a space.
 * @tc.level     : Level 2
 */
void isblank_l_3200(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"\r\n\b\0\f";
    const wchar_t *p = str;
...
/**
 * @tc.name      : isblank_l_3300
 * @tc.desc      : Verify isblank_l process fail when using the zh_CN.UTF-8 character set 
 *                 When the parameter c is a wide char English letter,
 *                 and it is judged that the input wide character is not a space.
 * @tc.level     : Level 2
 */
void isblank_l_3300(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    const wchar_t *p = str;
...
/**
 * @tc.name      : isblank_l_3400
 * @tc.desc      : Verify isblank_l process fail when using the zh_CN.UTF-8 character set
 *                 When the parameter c is a wide char alphanumeric,
 *                 and it is judged that the input wide character is not a space.
 * @tc.level     : Level 2
 */
void isblank_l_3400(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"1234567890";
    const wchar_t *p = str;
...
/**
 * @tc.name      : isblank_l_3500
 * @tc.desc      : Verify isblank_l process fail when using the zh_CN.UTF-8 character set
 *                 When the parameter c is a wide char special character,
 *           and it is judged that the input wide character is not a space.
 * @tc.level     : Level 2
 */
void isblank_l_3500(void)
{
    int ret = RET_FALSE;
    const wchar_t *str = L"!@#$%^()+{}[]";
    const wchar_t *p = str;
...
/**
 * @tc.name      : isblank_l_3600
 * @tc.desc      : Verify isblank_l process success when using the zh_CN.UTF-8 character set
 *                 When the parameter c is a SPACE-like character,
 * @tc.level     : Level 0
 */
void isblank_l_3600(void)
{
    int ret = RET_FALSE;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
    int total = 0;
...
/**
 * @tc.name      : isblank_l_3700
 * @tc.desc      : Verify isblank_l process fail when using the zh_CN.UTF-8 character set
 *                 When the parameter c is a CJK RADICAL or Arabic character,
 *           and it is judged that the input wide character is not a space.
 * @tc.level     : Level 2
 */
void isblank_l_3700(void)
{
    int ret = RET_FALSE;
    int i = 0;
    locale_t m_locale = newlocale(LC_ALL_MASK, "zh_CN.UTF-8", NULL);
