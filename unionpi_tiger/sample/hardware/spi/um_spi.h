...
int SpiBufferWrite(uint8_t *buffer, uint32_t writeAddress, uint16_t numByteToWrite);

int SpiMultiPagesWrite(uint8_t *buffer, uint32_t writeAddress, uint16_t numByteToWrite);

int SpiLessPageWrite(uint8_t *buffer, uint32_t writeAddress, uint16_t numByteToWrite);
