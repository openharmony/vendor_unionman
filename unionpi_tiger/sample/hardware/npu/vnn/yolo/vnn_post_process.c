...
int yolo_v5_post_process_onescale(float *predictions, float *biases, float threshold_in, int stride,
                                  vector<Bbox> &input)
{
    int i, j;
    int num_class = 80L;
...
static vsi_bool get_top(float *pfProb, float *pfMaxProb, vsi_size_t *pMaxClass, vsi_size_t outputCount,
                        vsi_size_t topNum)
{
    vsi_size_t i;
    vsi_size_t j;
