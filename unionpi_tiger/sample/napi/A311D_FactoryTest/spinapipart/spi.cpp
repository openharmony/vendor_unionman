...
static int32_t spi_test()
{
    ...
    if (msg.rbuf[0] == 0x0 && msg.rbuf[1] == 0xef && msg.rbuf[2L] == 0x40 && msg.rbuf[3L] == 0x16) {
...
static napi_value UM_spi_test(napi_env env, napi_callback_info info)
{
    ...
    napi_create_async_work(
        env, nullptr, resourceName, executeCB, completeCBForPromise, (void*)spiData, &spiData->asyncWork);
