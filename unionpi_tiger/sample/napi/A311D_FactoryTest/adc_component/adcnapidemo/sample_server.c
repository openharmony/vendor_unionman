...
int main(int argc, char* argv[])
{
    ...
    (void)memset_s(&name, sizeof(struct sockaddr_un), 0, sizeof(struct sockaddr_un));
    int ret = 0;
    ...
    (void)strncpy_s(name.sun_path, sizeof(name.sun_path), SOCKET_NAME, sizeof(name.sun_path) - 1);
