...
public:
	...
	YangVideoDecoderBuffer* metaVideoBuffer;
	YangAudioPlayBuffer* metaAudioPlayBuffer;
	YangVideoEncoderBuffer *metaVideoEncoderBuffer;
	YangVideoBuffer *metaCaptureVideoBuffer;
	YangAudioBuffer *metaCaptureAudioBuffer;
#if Yang_OS_ANDROID
	void* nativeWindow;
#endif
